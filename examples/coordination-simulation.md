...
### Team Composition
- 2 committed human contributors
- 3 occasional human contributors
- 2 specialised AI agents
- 1 orchestration workflow handling research, summarisation, and handoff

### Coordination Models to Compare
1. Fully informal coordination
2. Elected temporary lead
3. Rotating stewardship model
4. Agent-assisted prioritisation
...
The simulation explores how different coordination structures behave under pressure.
...
Before teams commit to a coordination model, simulation can help answer:

- Can this system function without a formal CEO?
- Does the structure still work if contributors change every week?
- What breaks first: clarity, trust, speed, or accountability?
- When does “no hierarchy” stop being empowering and start becoming inefficient?

---

## Relevance to Decision Intelligence

Coordination systems are often adopted based on ideology, habit, or intuition.
